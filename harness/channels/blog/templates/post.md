...
## B2. 케이스 스터디형 (1,500~2,000자, H2 4개)
...
## B3. 비교·리뷰형 (2,000~2,500자, H2 5~6개)
...
## B4. 인사이트·관점형 (1,500~2,000자, H2 3~4개)

**목적**: 차별 메시지로 브랜드 권위 빌드  
...
## B5. 제품 소개형 (1,500~2,000자, H2 4~5개)
...
블로그 매체는 카드뉴스·이미지가 핵심이 아니므로 모든 매체에서 `image-director` 호출 skip. 헤더 이미지·본문 이미지가 필요하면 사용자가 직접 첨부 (또는 후속 작업 — 별도 image-director one-shot 호출).
